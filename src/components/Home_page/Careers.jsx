          ...
          <Kweesha_icon/>
            <div className='row mt-5'>
                ...
                <div className='col-lg-6 col-12 data'>
                  <h5 className='fs-4 title w-75 text-start'>Join the Kweesha Solutions Team: Exciting Career Opportunities in Problem-Solving and Sustainability</h5>
                  <p className='fs-6 mt-4 desc text-justify w-75 text-start'>At Kweesha Solutions, we're always on the lookout for talented individuals who share our passion for problem-solving and sustainability. We offer a myriad of career opportunities,
                  <br /><br />
